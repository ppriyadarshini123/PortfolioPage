...
<head>
    ...
    <title>Posters</title>
    <link rel="stylesheet" href="dist/css/posters.css" media="screen">
...
<div class="navContainer">
    ...
    <div class="wrapper2">
        <main>
            <div class="posters" id="myPosters">
                <h1 class="title">Posters</h1>
                <div class="jcarousel">
                    <ul class="alignHorizontal">
                        <li>
                            <i class="sprite sprite-activityClub-350x455"></i>
                        </li>
                        <li>
                            <i class="sprite sprite-summerCamp-325x455"></i>
                        </li>
                        <li>
                            <i class="sprite sprite-YogaDay-644x455"></i>
                        </li>
                        <li>
                            <i class="sprite sprite-independenceDay-587x455"></i>
                        </li>
                        <li class="hssPoster">
                            <i class="sprite sprite-HSS-Flyer-644x455 spritehss-flyer-350x247"></i>
                        </li>
                    </ul>
                </div><!--jcarousel-->
